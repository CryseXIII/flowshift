...
- [ ] Upgrade `v0.5.4` -> `v0.6.2` on a machine with existing clipboard history:
...
## M. Clipboard stream_v2 between two 0.6.2 peers

- [ ] With both machines on `v0.6.2` and connected, `GET /api/status` on either
