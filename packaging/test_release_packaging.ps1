...
try {
    ...
    try {
        ...
        $importOutput = & python -c 'import clipboard_flow_control_v2, clipboard_framing_v2, clipboard_materialize_v2, clipboard_object_store_v2, clipboard_preflight_v2, clipboard_resume_v2, clipboard_streaming_v2, tray, web_api, gui' 2>&1
